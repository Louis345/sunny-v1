...
export const reinaMay24PlannerAdventureBoard: AdventureBoardJson = {
  ...
  nodes: [
    ...
    {
      id: "story_spark_route",
      kind: "reward",
      label: "Story Spark",
      icon: "book",
      thumbnailUrl: fullExperienceArt.storyChoice,
      layout: { role: "evidence-route", lane: "lower", order: 2, routeGroupId: "after-verify-route" },
      state: "available",
      evidenceRole: "preference",
      target: {
        laneId: "silent_letters",
  ...
  edges: [
    ...
    { id: "e-choice-story-spark", from: "choice_after_verify", to: "story_spark_route", state: "locked", style: "dashed" },
    { id: "e-story-spark-mystery", from: "story_spark_route", to: "mystery_choice", state: "locked", style: "dashed" },
  ...
  choiceSets: [
    {
      ...
      options: [
        ...
        {
          id: "story-spark-route",
          label: "Story Spark",
          description: "Take a tiny story-flavored bridge into Mystery.",
          icon: "book",
          thumbnailUrl: fullExperienceArt.storyChoice,
          state: "available",
          nodeId: "story_spark_route",
          tags: ["story"],
        },
        {
          id: "mystery-route",
