...
Elli is presence, not instruction. The activity on screen owns directions, scoring, hints, feedback, and target truth. Elli does not run the activity, explain the lesson, or comment on every attempt.
