...
export const ACTIVITY_EVIDENCE_CONTRACTS: ActivityEvidenceContract[] = [
  ...
  {
    activityId: "word-radar",
    modeId: "independent_spelling_discovery",
    evidenceRole: "clean_spelling_recall",
    proofStrength: "diagnostic",
    bestFor: ["assigned-word starting-point capture"],
    weakFor: ["delayed retention", "mastery declaration"],
    contaminationRisks: ["unavailable audio", "letter assistance", "response capture failure"],
    requiresPerTargetEvidence: true,
    requiresCapturedResponse: true,
    masteryEligible: false,
    notes: ["Native assessment hides spelling and length, allows unknown responses, and derives evidence from frozen items and support history."],
  },
  {
    activityId: "word-radar",
  ...
  },
  {
    ...
    evidenceRole: "preference_reward",
    proofStrength: "preference_only",
    bestFor: ["earned reward bridge", "activity affinity", "recovery after valid domain work"],
    weakFor: ["baseline", "mastery gate", "standalone academic proof"],
    contaminationRisks: ["retry"],
    requiresPerTargetEvidence: false,
    requiresCapturedResponse: false,
    masteryEligible: false,
    notes: ["Spark Orb is a reward wrapper; embedded domain activities own academic evidence."],
  },
  {
    activityId: "spark-orb-charge",
    modeId: "charge_bridge",
    evidenceRole: "preference_reward",
    proofStrength: "preference_only",
    bestFor: ["short earned reward", "motivation pulse", "completion celebration"],
    weakFor: ["baseline", "mastery gate"],
    contaminationRisks: ["retry"],
    requiresPerTargetEvidence: false,
    requiresCapturedResponse: false,
    masteryEligible: false,
    notes: ["Use after valid work; charge and launch are engagement evidence only."],
  },
  {
    activityId: "spark-orb-charge",
    modeId: "domain_payload_wrapper",
    evidenceRole: "preference_reward",
    proofStrength: "practice",
    bestFor: ["domain-valid payload plus playful reward", "target practice persistence"],
    weakFor: ["clean cold baseline", "standalone mastery claim"],
    contaminationRisks: ["retry"],
    requiresPerTargetEvidence: true,
    requiresCapturedResponse: true,
    masteryEligible: false,
    notes: ["The wrapper requires embedded target evidence, but does not own mastery itself."],
  },
  {
  ...
  },
  {
    ...
    evidenceRole: "practice_fluency",
    proofStrength: "practice",
    bestFor: ["domain-valid baseline practice", "refillable generated shells"],
    weakFor: ["mastery gate", "unreviewed shell"],
    contaminationRisks: ["hint", "model-answer"],
    requiresPerTargetEvidence: true,
    requiresCapturedResponse: true,
    masteryEligible: false,
    notes: ["Approved generated shells capture per-target practice evidence via config refill."],
  },
  {
    activityId: "clock-game",
    modeId: DEFAULT_MODE,
    evidenceRole: "practice_fluency",
    proofStrength: "practice",
    bestFor: ["time telling practice", "clock reading evidence"],
    weakFor: ["non-time math", "mastery without varied prompts"],
    contaminationRisks: ["hint", "retry"],
    requiresPerTargetEvidence: true,
    requiresCapturedResponse: true,
    masteryEligible: false,
    notes: ["Clock match evidence is practice until mastery gate confirms transfer."],
  },
  {
    activityId: "coin-counter",
    modeId: DEFAULT_MODE,
    evidenceRole: "practice_fluency",
    proofStrength: "practice",
    bestFor: ["money reasoning practice", "coin value evidence"],
    weakFor: ["non-money math", "visible answer treated as mastery"],
    contaminationRisks: ["visible-word", "hint"],
    requiresPerTargetEvidence: true,
    requiresCapturedResponse: true,
    masteryEligible: false,
    notes: ["Coin counter evidence is practice until repeated success across prompts."],
  },
];
