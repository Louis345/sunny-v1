...
import * as CompanionContract from "../shared/companions/companionContract";
...
describe("COMPANION-API-001: companionContract + registry barrel", () => {
  it("exposes runtime COMPANION_API_VERSION as 1.0", () => {
    const mod = CompanionContract as unknown as Record<string, string | undefined>;
    expect(mod.COMPANION_API_VERSION).toBe("1.0");
  });
